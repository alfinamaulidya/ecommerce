                    ...
                    <div class="container-fluid">
                        <div class="header-bottom-wrapper">
                            <div class="logo-2 furniture-logo ptb-30">
                                <a href="/">
                                    <img height="60" style="transform:scale(1.5);object-fit: cover;" src="<?php echo e(asset('frontend/assets/img/logo/')); ?>" alt="">
                                </a>
                            </div>
                    ...
                    <div class="widget-wrapper">
                        ...
                        <img height="60" style="transform:scale(1.5);object-fit: cover;" src="<?php echo e(asset('frontend/assets/img/logo/')); ?>" alt="">
                            <div class="footer-about-2">
                                <p>There is a wide variety of books that we offer, complete with descriptions and synopses. <br> Buy your favorite books on My BookStore, all your wish books are here!</p>
                            </div>
                        </div><br>
                        <div class="footer-widget mb-30">
                            ...
                            <div class="footer-info-wrapper-3">
                                <div class="footer-address-furniture">
                                    ...
                                    <div class="footer-info-content3">
                                        <p> Jl. Raya Darmo Permai I No.29 60226 Surabaya Jawa Timur <br>JL. Raya 474, Jl. Merr Kalijudan, Penjaringan Sari, Kec. Mulyorejo Kota SBY Jawa Timur</p>
                                    </div>
                                </div><br>
                                <div class="footer-address-furniture">
                                    <div class="footer-info-icon3">
                                    ...
                                    <div class="footer-info-content3">
                                        <p>+62 811-3056-878 <br>+62 31 99044299</p>
                                    </div>
                                </div>
                                <div class="footer-address-furniture">
                                    <div class="footer-info-icon3">
                                    ...
                                    <div class="footer-info-content3">
                                        <p><a href="#"> tbmonline@gmail.com</a> <br><a href="#"> tbkmurahonline@mail.info</a></p>
                                    </div>
                                </div>
                            </div>
                        </div><br><br><br>
                    ...
                    <div class="row">
                        <div class="col-12 text-center">
                            <div class="copyright-furniture">
                                <p>Copyright © <a href="https://hastech.company/">My BookStore</a> 2023 . All Right Reserved.</p>
                            </div>
                        </div>
                    </div>
                </div>
...
<?php /**PATH C:\Users\Alfina Maulidya\Documents\PF\UAS\laravel-ecommerce\resources\views/layouts/frontend.blade.php ENDPATH**/ ?>