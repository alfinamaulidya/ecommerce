...
} elseif ($_instance->childHasBeenRendered('e5IFEEk')) {
    $componentId = $_instance->getRenderedChildComponentId('e5IFEEk');
    $componentTag = $_instance->getRenderedChildComponentTagName('e5IFEEk');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('e5IFEEk');
} else {
    $response = \Livewire\Livewire::mount('shop.single-product-review-component', ['product' => $product]);
    $html = $response->html();
    $_instance->logRenderedChild('e5IFEEk', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
                                    </div>
...
<?php echo $__env->make('layouts.frontend', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\Alfina Maulidya\Documents\PF\UAS\laravel-ecommerce\resources\views/frontend/product/show.blade.php ENDPATH**/ ?>