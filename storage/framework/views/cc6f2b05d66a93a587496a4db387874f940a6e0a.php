                    ...
                    <div class="row">
                        <div class="col-6">
                            <div class="form-group">
                                ...
                                <input class="form-control" id="name" type="text" name="name" value="<?php echo e(old('name', $category->name)); ?>">
                            ...
                            <div class="form-group">
                                ...
                                <select name="category_id" id="category_id" class="form-control">
                                    ...
                                    <?php $__empty_1 = true; $__currentLoopData = $parent_categories; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $parent_category): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                                        <option value="<?php echo e($parent_category->id); ?>" <?php echo e(old('category_id', $category->category_id) == $parent_category->id ? 'selected' : null); ?>>
                    ...
                    <div class="row pt-4">
                        ...
                        <label for="cover">Cover image</label><br>
                            <?php if($category->cover): ?>
                                <img
                                    class="mb-2"
                                    src="<?php echo e(Storage::url('images/categories/' . $category->cover)); ?>"
                                    alt="<?php echo e($category->name); ?>" width="100" height="100">
                            <?php else: ?>
                                <img
                                    class="mb-2"
                                    src="<?php echo e(asset('img/no-img.png')); ?>" alt="<?php echo e($category->name); ?>" width="60" height="60">
                            <?php endif; ?>
                            <br>
...
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\Alfina Maulidya\Documents\PF\UAS\laravel-ecommerce\resources\views/admin/categories/edit.blade.php ENDPATH**/ ?>